...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          ResumeTrail saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets ResumeTrail apart from other resume builders and templates?",
    answer: (
      <>
        {/* <p>
        ...
        <p>
          <span className="font-semibold">
             OpenResume is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, ResumeTrail believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          ResumeTrail doesn’t require sign up to use the app, and all inputted
  ...
  // },
  {
    question: "Q3. How can I support ResumeTrail?",
    answer: (
      <>
        <p>
          The best way to support ResumeTrail is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:goyal.keshav181@gmail.com">goyal.keshav181@gmail.com</Link>{" "}
          {/* or{" "}
